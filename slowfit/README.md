...
**SlowFit**은 슬로우조깅 애호가들과 식단 관리에 관심 있는 사용자들이 경험과 정보를 공유할 수 있는 커뮤니티 플랫폼입니다. 사용자들은 게시판을 통해 조깅 기록, 식단 정보, 자격증 관련 내용을 공유하고, 실시간 채팅으로 커뮤니티 멤버들과 소통할 수 있습니다.

### 핵심 기능

- 📝 **게시판**: JOGGING, DIET, CERTIFICATION 세 가지 카테고리의 게시판
