...
export default function PostDetailPage() {
  ...
  const isAuthor = Boolean(post && currentUsername && post.username === currentUsername);
              ...
              {isAuthor && (
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <button
                    ...
                    style={{ padding: '0.5rem 0.75rem', cursor: 'pointer', borderRadius: 4, border: '1px solid #1976d2', background: '#fff', color: '#1976d2' }}
                  >
                    수정
                  </button>
                  <button
                    ...
                    style={{ padding: '0.5rem 0.75rem', cursor: deleteSubmitting ? 'not-allowed' : 'pointer', borderRadius: 4, border: '1px solid #d32f2f', background: '#fff', color: '#d32f2f' }}
                  >
          ...
          <section>
            ...
            {comments.length === 0 ? (
              ...
              comments.map((comment) => {
                const isCommentAuthor = Boolean(currentUsername && comment.username === currentUsername);
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem' }}>
                      ...
                      {isCommentAuthor && (
                        <button
                          ...
                          style={{ padding: '0.35rem 0.6rem', cursor: 'pointer', borderRadius: 4, border: '1px solid #d32f2f', background: '#fff', color: '#d32f2f' }}
                        >
                          삭제
                        </button>
                      )}
